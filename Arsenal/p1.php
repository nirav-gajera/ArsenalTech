...
<html>
    <head> 
        <style>
            ...
            form
            {
                ...
                background-image: url("../Arsenal/abc.jpg");
  ...
  return $data;
    ...
    <center>
        ...
        <td>Birth date:</td><td><input type="date" name="bdate"></td></tr>
        <td> Gender:</td><td><input type="radio" name="gender">male
        <input type="radio" name="gender" value="female">female
        <tr>
            <td rowspan="4" name="hobbies"> Hobbies:</td>
            <td><input type="checkbox"  name="hobbies">Cricket</td><tr>
            <td><input type="checkbox" name="hobbies">writing</td><tr>
            <td><input type="checkbox" name="hobbies">Reading</td><tr>
            <td><input type="checkbox"  name="hobbies">singing</td><tr>
            <tr>
        ...
        <td>City:</td><td><select name="city" value="city">
         ...
         <tr>    
         <td>Contact No.:</td><td><input type="text" size="25" name="cno"></td></tr>
         <tr>
